/**
 * Manosaba Character Name Localizations
 */

import { Locale, LocalizationMap } from "discord.js";
import type { ManosabaCharacterId } from "../characters.js";

export const MANOSABA_CHARACTER_NAMES = {
  ema: {
...
} satisfies Record<ManosabaCharacterId, LocalizationMap>;
