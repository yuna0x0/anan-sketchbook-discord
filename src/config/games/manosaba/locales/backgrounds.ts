/**
 * Manosaba Background Name Localizations
 */

import { Locale, LocalizationMap } from "discord.js";
import type { ManosabaBackgroundId } from "../backgrounds.js";

export const MANOSABA_BACKGROUND_NAMES = {
  // 1_1: 牢房內部
  bg_001_001: {
...
} satisfies Record<ManosabaBackgroundId, LocalizationMap>;
